...
mkdir -p out/target/product/msm8625/obj/KERNEL_OBJ/drivers/input/touchscreen
cp packages/more/gsl_point_id.o out/target/product/msm8625/obj/KERNEL_OBJ/drivers/input/touchscreen
